...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">@ng-dnd/multi-backend documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter modules">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            <li class="link">
                                <a href="modules/DndMultiBackendModule.html" data-type="entity-link" >DndMultiBackendModule</a>
                            </li>
                </ul>
                </li>
                    <li class="chapter">
